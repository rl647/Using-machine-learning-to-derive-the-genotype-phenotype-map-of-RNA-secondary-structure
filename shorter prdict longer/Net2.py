...
#         self.bns.append(bn)
        ...
        self.fc3 = nn.Linear(180,250)
        self._set_init(self.fc3)
        self.bn3 = nn.BatchNorm1d(250,momentum=0.5)

        self.fc4 = nn.Linear(250,160)
        self._set_init(self.fc4)
        self.bn4 = nn.BatchNorm1d(160,momentum=0.5)

        self.fc5 = nn.Linear(160,100)
        self._set_init(self.fc4)
